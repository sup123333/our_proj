    ...
    public void run(String... args) {
        List.of(
                ...
                Service.builder().name("Расклад на 3 вопроса")
                        ...
                        .price(new BigDecimal("500.00")).pointsReward(10).active(true).build(),
                Service.builder().name("Расклад на 4 вопроса")
                        .description("Четыре вопроса в одном сеансе — для тех, кому нужно немного больше глубины.")
                        .price(new BigDecimal("650.00")).pointsReward(10).active(true).build(),
                ...
                Service.builder().name("Расклад на 6 вопросов")
                        .description("Шесть вопросов — расширенный разбор. Действует скидка за объём на темах с карточек.")
                        .price(new BigDecimal("1250.00")).pointsReward(20).active(true).build(),
